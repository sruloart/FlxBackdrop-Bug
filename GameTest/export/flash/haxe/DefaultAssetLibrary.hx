...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/layer1.png", __ASSET__assets_images_layer1_png);
		type.set ("assets/images/layer1.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		addExternal("assets/images/layer1.png", "image", "assets/images/layer1.png");
...
class __ASSET__assets_images_layer1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
